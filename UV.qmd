...
#| fig-cap: "Using a 40 mJ/cm lamp (or greater), expected reduction in bacterial load"
#| fig-width: 6
#| fig-height: 3.5

UV_2 <- filter(UV, fluence>40 & log10_reduction <3)
ggplot(UV_2, aes(x=log10_reduction)) +
  theme_bw(base_size=18) + 
  geom_histogram() +
  labs(x="(x)Log10 reduction in bacterial load", y="")
```
